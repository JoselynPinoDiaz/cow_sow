...
//** METODO GET VISUALIZAR GANADO */
  ...
  getinfoGanado(NUMERO_SERIE): Observable<any>{
    return this.http.get(this.url + '/getGanado')

  }


  //** METODO POST AGREGAR GANADO */
  postGanado(NUMERO_SERIE,TIPO_ANIMAL,RAZA,PESO,ANOS_EDAD,MESES_EDAD,CRIAS,TIPO_PRODUCCION,FECHA,PRECIO_COMPRA,PRECIO_VENTA,VACUNA,PRECIO_VACUNA,ENFERMEDAD,MEDICAMENTO,PRECIO_MEDICAMENTO,ID_PROPIEDAD): Observable<any>{
