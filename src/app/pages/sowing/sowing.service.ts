...
export class SowingService {
  ...
  infoSiembra(ID_SIEMBRA: string): Observable<any>{
    return this.http.get(this.url + '/getSiembra')
  }
...
//** METODO POST AGREGAR SIEMBRA */
  agregarSiembra(TIPO_SIEMBRA,TIPO_FRU_VER,COLOR,VARIEDAD,CANTIDAD,METROS_OCUPADOS,FECHA,PRECIO_COMPRA,PRECIO_VENTA,FERTILIZANTE,PRECIO_FERTILIZANTE,FUMIGACION,PRECIO_FUMIGACION,ID_PROPIEDAD): Observable<any>{
